...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/izeoe'}, },}}
...
data = {
{
{text = 'قناة السورس', url = 't.me/izeoe'}, 
},
}
}
...
data = {
{
{text = 'Channel Source ،', url = 't.me/izeoe'}, 
},
{
...
if text == (Redis:get(Revor.."Revor:Name:Bot") or "ميلانو") then
local NamesBot = (Redis:get(Revor.."Revor:Name:Bot") or "ميلانو")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس ميلانو؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس ميلانو؟ ", 
"كم مره حبيت؟ ", 
...
local CmdStart = '*\n⌔︙أهلآ بك في بوت '..(Redis:get(Revor.."Revor:Name:Bot") or "ميلانو")..
